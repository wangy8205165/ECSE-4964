...
def distributed_gradient_descent(Xs, ys, lr=0.01, iterations=1000, lambda_reg=0.01):
...
def stochastic_distributed_gradient_descent(Xs, ys, lr=0.1, iterations=1000, lambda_reg=0.01):
    n_workers = len(Xs)
...
def mini_batch_distributed_gradient_descent(Xs, ys, lr=0.01, iterations=1000, lambda_reg=0.01, batch_size=100):
    n_workers = len(Xs)
    n_features = Xs[0].shape[1] + 1  # Include intercept term
    theta = np.zeros(n_features)
    loss_history = []
...
plt.plot(iterat, loss_history_s,"red",label="Gradient Descent",linestyle="-")
plt.plot(iterat, loss_history_g,"blue",label="Stochastic Descent",linestyle="-.") 
...
plt.plot(communications, loss_history_s,"red",label="Gradient Descent",linestyle="-")
plt.plot(communications, loss_history_g,"blue",label="Stochastic Descent",linestyle="-.") 
plt.plot(communications, loss_history_m,"cyan",label="minibatch_gd",linestyle="--")
